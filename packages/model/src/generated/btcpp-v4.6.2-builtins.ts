// Generated from packages/model/resources/btcpp/4.6.2/btcpp_default_models.xml.
...
export const btcppV4_6_2BuiltinModels = [
  {
    id: "AlwaysFailure",
    kind: "Action",
    ports: [],
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        direction: "input",
        type: "BT::AnyTypeAllowed",
        description: "Value to be written int othe output_key",
        required: true,
      },
    ],
  },
...
export const btcppV4_6_2GenericSubTreeModel = {
  id: "SubTree",
  kind: "SubTree",
  ports: [
    {
