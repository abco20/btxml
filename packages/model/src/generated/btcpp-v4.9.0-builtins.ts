// Generated from packages/model/resources/btcpp/4.9.0/btcpp_default_models.xml.
...
export const btcppV4_9_0BuiltinModels = [
  {
    id: "AlwaysFailure",
    kind: "Action",
    ports: [],
    ...
    ports: [
      {
        ...
        defaultValue: "false",
        description:
          "If true, execute the catch child when the node is halted during the try-block",
        required: false,
      },
    ],
  },
...
export const btcppV4_9_0GenericSubTreeModel = {
  id: "SubTree",
  kind: "SubTree",
  ports: [
    {
